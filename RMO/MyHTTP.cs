...
namespace My
{
    class HTTP
    {
        ...
        public class DownloadThread
        {
            ...
            public string _downloadParameters = "";
            public string DownloadParameters
            {
                get { return _downloadParameters; }
                set { _downloadParameters = value; }
            }
            ...
            public void Download()
            {
                if (CompleteCallback != null && DownloadUrl != "")
                {
                    ...
                    downloadedData = webDL.Download(DownloadUrl, DownloadParameters, ProgressCallback);
        ...
        /* http://forum.codecall.net/c-programming/2760-c-app-login-information-connecting-site.html
         * You will use the HttpWebRequest, you need to set the Method property to "POST" or "GET", 
         * which will indicate that you are posting data. Also, you will have to call GetRequestStream, 
         * and write to the stream the content of the forms data.
        ...
        public class WebDownload
        {
            ...
            private void ResponseCallback(IAsyncResult ar)
            {
                ...
                try { resp = req.EndGetResponse(ar); }
                catch { allDone.Set(); return; }

                // Find the data size from the headers.
                string strContentLength = resp.Headers["Content-Length"];
                if (strContentLength != null)
                {
                    info.dataLength = System.Convert.ToInt32(strContentLength);
